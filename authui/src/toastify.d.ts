// Type definition for toastify v1.12.0
...
declare module "toastify-js" {
  ...
  declare interface ToastifyOptions {
  ...
  declare class ToastifyInstance {
    /**
     * The configuration object to configure Toastify
     */
    readonly options: ToastifyOptions;
    /**
  ...
  declare function StartToastifyInstance(
  ...
  export { ToastifyInstance, ToastifyOptions };
}
