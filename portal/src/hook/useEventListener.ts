 ...
 * @public
 * @see [Referenced from usehooks-ts](https://github.com/juliencrn/usehooks-ts/blob/20667273744a22dd2cd2c48c38cd3c10f254ae47/packages/usehooks-ts/src/useEventListener/useEventListener.ts)
 * @example
 * ```tsx
