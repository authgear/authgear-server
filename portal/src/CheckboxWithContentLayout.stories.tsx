...
function WithPlainCheckboxRender() {
  ...
  return (
    <CheckboxWithContentLayout>
      ...
      />
      <Text variant="small">
        When enabled, sign-ins from domains in the list below are blocked. One
        domain per line.
      </Text>
    </CheckboxWithContentLayout>
  );
...
function WithCheckboxAndTooltipRender() {
  ...
  return (
    <CheckboxWithContentLayout>
      ...
      <Text variant="small" styles={{ root: { marginTop: 8 } }}>
        Additional controls appear here when the checkbox is on (pattern from
        login ID email settings).
      </Text>
    </CheckboxWithContentLayout>
  );
}
...
export const WithPlainCheckbox: Story = {
  render: () => <WithPlainCheckboxRender />,
};

export const WithCheckboxAndTooltip: Story = {
  render: () => <WithCheckboxAndTooltipRender />,
};
