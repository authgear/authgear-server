...
export type AuthgearGTMEventTypeV2 =
  ...
  | "getStarted.clicked-feature_bot_protection"
  | "getStarted.clicked-feature_user_management"
  | "getStarted.clicked-feature_admin_api"
  | "getStarted.clicked-feature_custom_ui"
  | "getStarted.clicked-feature_hooks"
  | "getStarted.clicked-discord"
  | "getStarted.clicked-email"
  | "getStarted.clicked-sales"
  | "getStarted.clicked-docs"
  | "getStarted.clicked-api_reference"
  | "getStarted.clicked-quickstart"
