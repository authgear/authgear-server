 ...
 * });
 */
export function useScreenNavQueryQuery(baseOptions: Apollo.QueryHookOptions<ScreenNavQueryQuery, ScreenNavQueryQueryVariables> & ({ variables: ScreenNavQueryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
