...
export type ViewerQueryQuery = { __typename?: 'Query', viewer?: { __typename?: 'User', id: string, email?: string | null, projectQuota?: number | null, projectOwnerCount: number } | null };
