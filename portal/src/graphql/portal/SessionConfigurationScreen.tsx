...
const SessionConfigurationScreenContent: React.FC<HooksSettingsContentProps> =
  function SessionConfigurationScreenContent(props) {
...
const SessionConfigurationScreen: React.FC =
