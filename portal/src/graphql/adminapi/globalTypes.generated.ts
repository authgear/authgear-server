...
export enum AuditLogActivityType {
  ...
  UserSettingsPrimaryPasswordChanged = 'USER_SETTINGS_PRIMARY_PASSWORD_CHANGED',
  UserSettingsSecondaryPasswordChanged = 'USER_SETTINGS_SECONDARY_PASSWORD_CHANGED',
