...
export enum AuditLogActivityType {
  ...
  AdminApiMutationCreateInitialAccessTokenExecuted = 'ADMIN_API_MUTATION_CREATE_INITIAL_ACCESS_TOKEN_EXECUTED',
  ...
  AdminApiMutationDeleteDynamicClientExecuted = 'ADMIN_API_MUTATION_DELETE_DYNAMIC_CLIENT_EXECUTED',
  ...
  AdminApiMutationRevokeInitialAccessTokenExecuted = 'ADMIN_API_MUTATION_REVOKE_INITIAL_ACCESS_TOKEN_EXECUTED',
  ...
  OauthClientRegistered = 'OAUTH_CLIENT_REGISTERED',
  OauthClientRegistrationFailed = 'OAUTH_CLIENT_REGISTRATION_FAILED',
  OauthClientResolutionFailed = 'OAUTH_CLIENT_RESOLUTION_FAILED',
  OauthClientResolved = 'OAUTH_CLIENT_RESOLVED',
