...
export enum AuditLogActivityType {
  ...
  PasswordPrimaryChanged = 'PASSWORD_PRIMARY_CHANGED',
  PasswordPrimaryForceChanged = 'PASSWORD_PRIMARY_FORCE_CHANGED',
  PasswordPrimaryReset = 'PASSWORD_PRIMARY_RESET',
  PasswordSecondaryChanged = 'PASSWORD_SECONDARY_CHANGED',
  PasswordSecondaryForceChanged = 'PASSWORD_SECONDARY_FORCE_CHANGED',
