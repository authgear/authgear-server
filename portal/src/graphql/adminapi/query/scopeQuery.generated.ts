...
export type ScopeQueryQuery = { __typename?: 'Query', node?: { __typename: 'AuditLog' } | { __typename: 'Authenticator' } | { __typename: 'Authorization' } | { __typename: 'FraudProtectionDecisionRecord' } | { __typename: 'Group' } | { __typename: 'Identity' } | { __typename: 'InitialAccessToken' } | { __typename: 'OAuthClient' } | { __typename: 'Resource' } | { __typename: 'Role' } | { __typename: 'Scope', id: string, scope: string, description?: string | null, resourceID: string, createdAt: any, updatedAt: any, accessPolicy: { __typename?: 'AccessPolicy', allowDynamicThirdPartyClientAccess: boolean } } | { __typename: 'Session' } | { __typename: 'User' } | null };
