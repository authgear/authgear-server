...
export type AuditLogEntryQueryQuery = { __typename?: 'Query', node?: { __typename: 'AuditLog', id: string, createdAt: any, activityType: Types.AuditLogActivityType, ipAddress?: string | null, userAgent?: string | null, clientID?: string | null, data?: any | null, user?: { __typename?: 'User', id: string } | null } | { __typename: 'Authenticator' } | { __typename: 'Authorization' } | { __typename: 'FraudProtectionDecisionRecord' } | { __typename: 'Group' } | { __typename: 'Identity' } | { __typename: 'Resource' } | { __typename: 'Role' } | { __typename: 'Scope' } | { __typename: 'Session' } | { __typename: 'User' } | null };
