ALTER TABLE app ADD COLUMN _id uuid UNIQUE;
UPDATE app SET _id = id::uuid;

ALTER TABLE artifact ADD COLUMN _id uuid UNIQUE;
UPDATE artifact SET _id = id::uuid;

ALTER TABLE cloud_code ADD COLUMN _id uuid UNIQUE;
UPDATE cloud_code SET _id = id::uuid;

ALTER TABLE cloud_code_backend ADD COLUMN _id uuid UNIQUE;
UPDATE cloud_code_backend SET _id = id::uuid;

ALTER TABLE config ADD COLUMN _id uuid UNIQUE;
UPDATE config SET _id = id::uuid;

ALTER TABLE deployment ADD COLUMN _id uuid UNIQUE;
UPDATE deployment SET _id = id::uuid;

ALTER TABLE deployment_hook ADD COLUMN _id uuid UNIQUE;
UPDATE deployment_hook SET _id = id::uuid;

ALTER TABLE deployment_route ADD COLUMN _id uuid UNIQUE;
UPDATE deployment_route SET _id = id::uuid;

ALTER TABLE domain ADD COLUMN _id uuid UNIQUE;
UPDATE domain SET _id = id::uuid;

ALTER TABLE invitation ADD COLUMN _id uuid UNIQUE;
UPDATE invitation SET _id = id::uuid;

ALTER TABLE microservice ADD COLUMN _id uuid UNIQUE;
UPDATE microservice SET _id = id::uuid;

ALTER TABLE plan ADD COLUMN _id uuid UNIQUE;
UPDATE plan SET _id = id::uuid;

ALTER TABLE secret ADD COLUMN _id uuid UNIQUE;
UPDATE secret SET _id = id::uuid;


ALTER TABLE app DROP CONSTRAINT app_plan_id_fkey;
ALTER TABLE app ALTER COLUMN plan_id TYPE uuid USING plan_id::uuid;
...
ALTER TABLE app ALTER COLUMN config_id TYPE uuid USING config_id::uuid;
...
ALTER TABLE app ALTER COLUMN last_deployment_id TYPE uuid USING last_deployment_id::uuid;
...
ALTER TABLE app_user ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
...
ALTER TABLE artifact ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
ALTER TABLE artifact ADD CONSTRAINT artifact_app_id_fkey FOREIGN KEY (app_id) REFERENCES app(_id);

ALTER TABLE cloud_code DROP CONSTRAINT cloud_code_app_id_fkey;
ALTER TABLE cloud_code ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
ALTER TABLE cloud_code ADD CONSTRAINT cloud_code_app_id_fkey1 FOREIGN KEY (app_id) REFERENCES app(_id);

ALTER TABLE cloud_code DROP CONSTRAINT cloud_code_artifact_id_fkey;
ALTER TABLE cloud_code ALTER COLUMN artifact_id TYPE uuid USING artifact_id::uuid;
...
ALTER TABLE cloud_code ALTER COLUMN backend_id TYPE uuid USING backend_id::uuid;
...
ALTER TABLE cloud_code_secret ALTER COLUMN cloud_code_id TYPE uuid USING cloud_code_id::uuid;
...
ALTER TABLE cloud_code_secret ALTER COLUMN secret_id TYPE uuid USING secret_id::uuid;
...
ALTER TABLE deployment ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
...
ALTER TABLE deployment_cloud_code ALTER COLUMN deployment_id TYPE uuid USING deployment_id::uuid;
...
ALTER TABLE deployment_cloud_code ALTER COLUMN cloud_code_id TYPE uuid USING cloud_code_id::uuid;
...
ALTER TABLE deployment_hook ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
...
ALTER TABLE deployment_microservice ALTER COLUMN deployment_id TYPE uuid USING deployment_id::uuid;
...
ALTER TABLE deployment_microservice ALTER COLUMN microservice_id TYPE uuid USING microservice_id::uuid;
...
ALTER TABLE deployment_route DROP CONSTRAINT deployment_route_app_id_fkey;
ALTER TABLE deployment_route ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
ALTER TABLE deployment_route ADD CONSTRAINT cloud_code_app_id_fkey FOREIGN KEY (app_id) REFERENCES app(_id);

ALTER TABLE domain DROP CONSTRAINT domain_app_id_fkey;
ALTER TABLE domain ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
...
ALTER TABLE invitation ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
...
ALTER TABLE microservice ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
...
ALTER TABLE microservice ALTER COLUMN artifact_id TYPE uuid USING artifact_id::uuid;
...
ALTER TABLE microservice_secret ALTER COLUMN microservice_id TYPE uuid USING microservice_id::uuid;
...
ALTER TABLE microservice_secret ALTER COLUMN secret_id TYPE uuid USING secret_id::uuid;
...
ALTER TABLE secret ALTER COLUMN app_id TYPE uuid USING app_id::uuid;
