...
The developer should send the migration token (generated by the developer) to the workflow. Authgear will send the migration token as the request body to the hook, and the hook should return the identities' and authenticators' MigrateSpec.
