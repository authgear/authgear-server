...
// Source: github.com/oursky/skygear/oddb (interfaces: Conn,Database)
...
import (
	...
	oddb "github.com/oursky/skygear/oddb"
)
...
func (_m *MockConn) CreateUser(_param0 *oddb.UserInfo) error {
...
func (_m *MockConn) GetAsset(_param0 string, _param1 *oddb.Asset) error {
...
func (_m *MockConn) GetDevice(_param0 string, _param1 *oddb.Device) error {
...
func (_m *MockConn) GetUser(_param0 string, _param1 *oddb.UserInfo) error {
...
func (_m *MockConn) GetUserByPrincipalID(_param0 string, _param1 *oddb.UserInfo) error {
...
func (_m *MockConn) PrivateDB(_param0 string) oddb.Database {
	ret := _m.ctrl.Call(_m, "PrivateDB", _param0)
	ret0, _ := ret[0].(oddb.Database)
	return ret0
}
...
func (_m *MockConn) PublicDB() oddb.Database {
...
func (_m *MockConn) QueryDevicesByUser(_param0 string) ([]oddb.Device, error) {
	ret := _m.ctrl.Call(_m, "QueryDevicesByUser", _param0)
	ret0, _ := ret[0].([]oddb.Device)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (_m *MockConn) QueryRelation(_param0 string, _param1 string, _param2 string) []oddb.UserInfo {
	ret := _m.ctrl.Call(_m, "QueryRelation", _param0, _param1, _param2)
	ret0, _ := ret[0].([]oddb.UserInfo)
	return ret0
}
...
func (_m *MockConn) QueryUser(_param0 []string) ([]oddb.UserInfo, error) {
	ret := _m.ctrl.Call(_m, "QueryUser", _param0)
	ret0, _ := ret[0].([]oddb.UserInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockConnRecorder) QueryUser(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "QueryUser", arg0)
}
...
func (_m *MockConn) SaveAsset(_param0 *oddb.Asset) error {
...
func (_m *MockConn) SaveDevice(_param0 *oddb.Device) error {
...
func (_m *MockConn) Subscribe(_param0 chan oddb.RecordEvent) error {
...
func (_m *MockConn) UpdateUser(_param0 *oddb.UserInfo) error {
...
func (_m *MockDatabase) Conn() oddb.Conn {
	ret := _m.ctrl.Call(_m, "Conn")
	ret0, _ := ret[0].(oddb.Conn)
	return ret0
}
...
func (_m *MockDatabase) Delete(_param0 oddb.RecordID) error {
...
func (_m *MockDatabase) Extend(_param0 string, _param1 oddb.RecordSchema) error {
...
func (_m *MockDatabase) Get(_param0 oddb.RecordID, _param1 *oddb.Record) error {
...
func (_m *MockDatabase) GetMatchingSubscriptions(_param0 *oddb.Record) []oddb.Subscription {
	ret := _m.ctrl.Call(_m, "GetMatchingSubscriptions", _param0)
	ret0, _ := ret[0].([]oddb.Subscription)
	return ret0
}
...
func (_m *MockDatabase) GetSubscription(_param0 string, _param1 string, _param2 *oddb.Subscription) error {
...
func (_m *MockDatabase) GetSubscriptionsByDeviceID(_param0 string) []oddb.Subscription {
...
func (_m *MockDatabase) Query(_param0 *oddb.Query) (*oddb.Rows, error) {
	ret := _m.ctrl.Call(_m, "Query", _param0)
	ret0, _ := ret[0].(*oddb.Rows)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (_m *MockDatabase) Save(_param0 *oddb.Record) error {
...
func (_m *MockDatabase) SaveSubscription(_param0 *oddb.Subscription) error {
