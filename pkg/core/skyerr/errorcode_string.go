...
const (
	_ErrorCode_name_0 = ""
	_ErrorCode_name_1 = "UnexpectedErrorUnexpectedAuthInfoNotFound"
)

var (
	_ErrorCode_index_0 = [...]uint16{0, 16, 32, 52, 74, 92, 102, 117, 127, 143, 161, 183, 195, 215, 229, 242, 269}
