...
//go:generate mockgen -package skydb -source=conn.go -destination=mockgen_conn_test.go
...
//go:generate mockgen -destination=mock_skydb/mockgen_conn.go github.com/skygeario/skygear-server/pkg/server/skydb Conn
type Conn interface {
