...
func (_m *MockConn) GetOAuthInfoByProvicerAndUserID(_param0 string, _param1 string, _param2 *skydb.OAuthInfo) error {
	ret := _m.ctrl.Call(_m, "GetOAuthInfoByProvicerAndUserID", _param0, _param1, _param2)
	ret0, _ := ret[0].(error)
	return ret0
}
