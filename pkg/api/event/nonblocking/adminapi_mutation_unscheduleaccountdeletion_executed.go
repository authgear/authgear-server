...
func (e *AdminAPIMutationUnscheduleAccountDeletionExecutedEventPayload) ReindexUserNeeded() bool {
	return false
}

func (e *AdminAPIMutationUnscheduleAccountDeletionExecutedEventPayload) IsUserDeleted() bool {
	return false
}
