...
func (e *AdminAPIMutationRevokeSessionExecutedEventPayload) ReindexUserNeeded() bool {
	return false
}

func (e *AdminAPIMutationRevokeSessionExecutedEventPayload) IsUserDeleted() bool {
	return false
}
