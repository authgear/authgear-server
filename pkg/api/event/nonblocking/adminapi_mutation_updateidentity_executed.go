...
func (e *AdminAPIMutationUpdateIdentityExecutedEventPayload) ReindexUserNeeded() bool {
	return false
}

func (e *AdminAPIMutationUpdateIdentityExecutedEventPayload) IsUserDeleted() bool {
	return false
}
