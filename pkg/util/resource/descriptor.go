...
type Descriptor interface {
	...
	UpdateResource(ctx context.Context, resource *ResourceFile, data []byte) (*ResourceFile, error)
}
...
func (d SimpleDescriptor) UpdateResource(_ context.Context, resource *ResourceFile, data []byte) (*ResourceFile, error) {
	return &ResourceFile{
...
func (d NewlineJoinedDescriptor) UpdateResource(_ context.Context, resource *ResourceFile, data []byte) (*ResourceFile, error) {
	return &ResourceFile{
		Location: resource.Location,
		Data:     data,
	}, nil
