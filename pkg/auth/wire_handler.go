...
func newWebAppAuthflowV2WhatsappOTPHandler(p *deps.RequestProvider) http.Handler {
	panic(wire.Build(
		DependencySet,
		AuthflowV2UIHandlerDependencySet,
		wire.Bind(new(http.Handler), new(*handlerwebappauthflowv2.AuthflowV2WhatsappOTPHandler)),
	))
}
