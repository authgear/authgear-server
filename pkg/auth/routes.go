...
func NewRouter(p *deps.RootProvider, configSource *configsource.ConfigSource) http.Handler {
	...
	router.Add(webapphandlerauthflowv2.ConfigureAuthflowV2OAuthProviderInactiveRoute(webappPageRoute), p.Handler(newWebAppAuthflowV2OAuthProviderInactiveHandler))
