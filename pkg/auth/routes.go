...
func NewRouter(p *deps.RootProvider, configSource *configsource.ConfigSource) *httproute.Router {
	...
	router.Add(webapphandlerauthflowv2.ConfigureAuthflowV2SetupFaceImageRoute(webappPageRoute), p.Handler(newWebappAuthflowV2SetupFaceImageHandler))
	router.Add(webapphandlerauthflowv2.ConfigureAuthflowV2SetupFaceImageSuccessRoute(webappPageRoute), p.Handler(newWebappAuthflowV2SetupFaceImageSuccessHandler))
	router.Add(webapphandlerauthflowv2.ConfigureAuthflowV2EnterFaceImageRoute(webappPageRoute), p.Handler(newWebappAuthflowV2EnterFaceImageHandler))
	router.Add(webapphandlerauthflowv2.ConfigureAuthflowV2EnterFaceImageSuccessRoute(webappPageRoute), p.Handler(newWebappAuthflowV2EnterFaceImageSuccessHandler))
