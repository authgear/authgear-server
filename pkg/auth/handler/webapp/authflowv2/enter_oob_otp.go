...
func NewInlinePreviewAuthflowEnterOOBOTPViewModel(
	...
	case model.LoginIDKeyTypePhone:
		channelForPreview = authenticatorConfig.OOB.SMS.PhoneOTPMode.GetDefaultChannel()
...
func (h *AuthflowV2EnterOOBOTPHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	handlers.PostAction("submit", func(ctx context.Context, s *webapp.Session, screen *webapp.AuthflowScreenWithFlowResponse) error {
		err := AuthflowEnterOOBOTPSchema.Validator().ValidateValue(ctx, handlerwebapp.FormToJSON(r.Form))
		if err != nil {
			return err
		}
