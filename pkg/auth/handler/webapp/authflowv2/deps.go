...
var DependencySet = wire.NewSet(
	...
	wire.Struct(new(AuthflowV2OAuthProviderMissingCredentialsHandler), "*"),
	wire.Struct(new(AuthflowV2OAuthProviderDemoCredentialHandler), "*"),
	...
	wire.Struct(new(AuthflowV2SettingsAuthorizedAppsHandler), "*"),
	wire.Struct(new(AuthflowV2SettingsAuthorizedAppHandler), "*"),
	...
	wire.Struct(new(AuthflowV2SettingsIdentityDeprecatedRedirectHandler), "*"),
