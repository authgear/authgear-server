...
var DependencySet = wire.NewSet(
	...
	wire.Struct(new(AuthflowV2SetupFaceImageHandler), "*"),
	wire.Struct(new(AuthflowV2SetupFaceImageSuccessHandler), "*"),
	wire.Struct(new(AuthflowV2EnterFaceImageHandler), "*"),
	wire.Struct(new(AuthflowV2EnterFaceImageSuccessHandler), "*"),
