...
func (h *InternalAuthflowV2SignupLoginHandler) ServeHTTP(w http.ResponseWriter, r *http.Request, options AuthflowV2SignupServeOptions) {
	...
	handlers.PostAction("oauth", func(s *webapp.Session, screen *webapp.AuthflowScreenWithFlowResponse) error {
		...
		err := HandleIdentificationBotProtection(authflow.FlowTypeSignupLogin, config.AuthenticationFlowIdentificationOAuth, screen.StateTokenFlowResponse, r.Form, input)
		if err != nil {
			return err
		}
	...
	handlers.PostAction("login_id", func(s *webapp.Session, screen *webapp.AuthflowScreenWithFlowResponse) error {
		...
		err = HandleIdentificationBotProtection(authflow.FlowTypeSignupLogin, config.AuthenticationFlowIdentification(identification), screen.StateTokenFlowResponse, r.Form, input)
		if err != nil {
			return err
		}
	...
	handlers.PostAction("passkey", func(s *webapp.Session, screen *webapp.AuthflowScreenWithFlowResponse) error {
		...
		err = HandleIdentificationBotProtection(authflow.FlowTypeSignupLogin, config.AuthenticationFlowIdentificationPasskey, screen.StateTokenFlowResponse, r.Form, input)
		if err != nil {
			return err
		}
