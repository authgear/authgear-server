...
func ConfigureAuthflowV2SettingsIdentityNewUsername(route httproute.Route) httproute.Route {
	return route.
		...
		WithPathPattern(AuthflowV2RouteSettingsIdentityAddUsername)
}
...
func (h *AuthflowV2SettingsIdentityNewUsernameHandler) GetData(w http.ResponseWriter, r *http.Request) (map[string]any, error) {
	data := map[string]any{}
