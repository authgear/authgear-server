		...
		Convey("CSP Directives", func() {
			testcases := []TestCase{
				...
				},
				{
					...
					ExpectedHeaders: map[string][]string{
						"Content-Security-Policy": {
							"default-src 'self'; script-src 'self' www.googletagmanager.com eu-assets.i.posthog.com challenges.cloudflare.com www.google.com https://browser.sentry-cdn.com http://cdn.authgear.com 'nonce-' 'strict-dynamic'; frame-src 'self' www.googletagmanager.com challenges.cloudflare.com www.google.com; font-src 'self' cdnjs.cloudflare.com static2.sharepointonline.com fonts.googleapis.com fonts.gstatic.com http://cdn.authgear.com; style-src 'self' cdnjs.cloudflare.com www.googletagmanager.com fonts.googleapis.com http://cdn.authgear.com 'sha256-WAyOw4V+FqDc35lQPyRADLBWbuNK8ahvYEaQIYF1+Ps=' 'sha256-fOghyYcDMsLl/lf7piKeVgEljdV7IgqwGymlDo5oDhU=' 'sha256-0EZqoz+oBhx7gF4nvY2bSqoGyy4zLjNF+SDQXGp/ZrY=' 'sha256-ZLjZaRfcYelvFE+8S7ynGAe0XPN7SLX6dirEzdvD5Mk=' 'unsafe-hashes' 'nonce-'; img-src 'self' http: https: data: http://cdn.authgear.com; object-src 'none'; base-uri 'none'; connect-src 'self' https://www.google-analytics.com ws://authgear.com wss://authgear.com; block-all-mixed-content; frame-ancestors http://authgearportal.com",
						},
					},
				},
				{
					...
					ExpectedHeaders: map[string][]string{
						"Content-Security-Policy": {
							"default-src 'self'; script-src 'self' www.googletagmanager.com eu-assets.i.posthog.com challenges.cloudflare.com www.google.com https://browser.sentry-cdn.com http://cdn.authgear.com 'nonce-' 'strict-dynamic'; frame-src 'self' www.googletagmanager.com challenges.cloudflare.com www.google.com; font-src 'self' cdnjs.cloudflare.com static2.sharepointonline.com fonts.googleapis.com fonts.gstatic.com http://cdn.authgear.com; style-src 'self' cdnjs.cloudflare.com www.googletagmanager.com fonts.googleapis.com http://cdn.authgear.com 'sha256-WAyOw4V+FqDc35lQPyRADLBWbuNK8ahvYEaQIYF1+Ps=' 'sha256-fOghyYcDMsLl/lf7piKeVgEljdV7IgqwGymlDo5oDhU=' 'sha256-0EZqoz+oBhx7gF4nvY2bSqoGyy4zLjNF+SDQXGp/ZrY=' 'sha256-ZLjZaRfcYelvFE+8S7ynGAe0XPN7SLX6dirEzdvD5Mk=' 'unsafe-hashes' 'nonce-'; img-src 'self' http: https: data: http://cdn.authgear.com; object-src 'none'; base-uri 'none'; connect-src 'self' https://www.google-analytics.com ws://authgear.com wss://authgear.com; block-all-mixed-content; frame-ancestors http://customui.com",
						},
					},
				},
				{
					...
					ExpectedHeaders: map[string][]string{
						"Content-Security-Policy": {
							"default-src 'self'; script-src 'self' www.googletagmanager.com eu-assets.i.posthog.com challenges.cloudflare.com www.google.com https://browser.sentry-cdn.com http://cdn.authgear.com 'nonce-' 'strict-dynamic'; frame-src 'self' www.googletagmanager.com challenges.cloudflare.com www.google.com; font-src 'self' cdnjs.cloudflare.com static2.sharepointonline.com fonts.googleapis.com fonts.gstatic.com http://cdn.authgear.com; style-src 'self' cdnjs.cloudflare.com www.googletagmanager.com fonts.googleapis.com http://cdn.authgear.com 'sha256-WAyOw4V+FqDc35lQPyRADLBWbuNK8ahvYEaQIYF1+Ps=' 'sha256-fOghyYcDMsLl/lf7piKeVgEljdV7IgqwGymlDo5oDhU=' 'sha256-0EZqoz+oBhx7gF4nvY2bSqoGyy4zLjNF+SDQXGp/ZrY=' 'sha256-ZLjZaRfcYelvFE+8S7ynGAe0XPN7SLX6dirEzdvD5Mk=' 'unsafe-hashes' 'nonce-'; img-src 'self' http: https: data: http://cdn.authgear.com; object-src 'none'; base-uri 'none'; connect-src 'self' https://www.google-analytics.com ws://authgear.com wss://authgear.com; block-all-mixed-content; frame-ancestors 'none'",
						},
