			...
			testcases := []TestCase{
				{
					...
					ExpectedHeaders: map[string][]string{
						"Content-Security-Policy": {
							"default-src 'self'; script-src 'self' https: 'nonce-' 'strict-dynamic'; frame-src 'self' https:; font-src 'self' https:; style-src 'self' 'unsafe-inline' 'unsafe-eval' https:; img-src 'self' http: https: data:; object-src 'none'; base-uri 'none'; connect-src 'self' https: ws://authgear.com wss://authgear.com; frame-ancestors http://authgearportal.com http://customui.com",
						},
					},
				},
				{
					...
					ExpectedHeaders: map[string][]string{
						"Content-Security-Policy": {
							"default-src 'self'; script-src 'self' https: 'nonce-' 'strict-dynamic'; frame-src 'self' https:; font-src 'self' https:; style-src 'self' 'unsafe-inline' 'unsafe-eval' https:; img-src 'self' http: https: data:; object-src 'none'; base-uri 'none'; connect-src 'self' https: ws://authgear.com wss://authgear.com; frame-ancestors http://authgearportal.com",
						},
					},
				},
				{
					...
					ExpectedHeaders: map[string][]string{
						"Content-Security-Policy": {
							"default-src 'self'; script-src 'self' https: 'nonce-' 'strict-dynamic'; frame-src 'self' https:; font-src 'self' https:; style-src 'self' 'unsafe-inline' 'unsafe-eval' https:; img-src 'self' http: https: data:; object-src 'none'; base-uri 'none'; connect-src 'self' https: ws://authgear.com wss://authgear.com; frame-ancestors http://customui.com",
						},
					},
				},
				{
					...
					ExpectedHeaders: map[string][]string{
						"Content-Security-Policy": {
							"default-src 'self'; script-src 'self' https: 'nonce-' 'strict-dynamic'; frame-src 'self' https:; font-src 'self' https:; style-src 'self' 'unsafe-inline' 'unsafe-eval' https:; img-src 'self' http: https: data:; object-src 'none'; base-uri 'none'; connect-src 'self' https: ws://authgear.com wss://authgear.com; frame-ancestors 'none'",
						},
