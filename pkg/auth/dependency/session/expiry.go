...
func computeSessionStorageExpiry(session *Session, cfg config.SessionConfiguration) (expiry time.Time) {
...
func checkSessionExpired(session *Session, now time.Time, cfg config.SessionConfiguration) (expired bool) {
