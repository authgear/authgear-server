...
func (n *NodeAuthenticationOOB) Prepare(ctx *newinteraction.Context, graph *newinteraction.Graph) error {
	return nil
}
...
func (n *NodeAuthenticationOOB) DeriveEdges(graph *newinteraction.Graph) ([]newinteraction.Edge, error) {
