...
func newHealthzHandler(p *deps.RequestProvider) http.Handler {
	...
	environmentConfig := rootProvider.EnvironmentConfig
	globalDatabaseCredentialsEnvironmentConfig := deps.ProvideDatabaseCredentials(environmentConfig)
	...
	globalRedisCredentialsEnvironmentConfig := deps.ProvideRedisCredentials(environmentConfig)
...
func newGraphQLHandler(p *deps.RequestProvider) http.Handler {
	...
	appService := &service.AppService{
		...
		RedisCredentials:         globalRedisCredentialsEnvironmentConfig,
	}
