...
func TestCSPDirectives(t *testing.T) {
	Convey("CSPDirectives", t, func() {
		...
		test(CSPDirectivesOptions{
			...
			"style-src 'self' cdnjs.cloudflare.com www.googletagmanager.com fonts.googleapis.com 'sha256-WAyOw4V+FqDc35lQPyRADLBWbuNK8ahvYEaQIYF1+Ps=' 'nonce-N0NC5'",
		...
		test(CSPDirectivesOptions{
			...
			"style-src 'self' cdnjs.cloudflare.com www.googletagmanager.com fonts.googleapis.com cdn.localhost:3000 'sha256-WAyOw4V+FqDc35lQPyRADLBWbuNK8ahvYEaQIYF1+Ps=' 'nonce-N0NC5'",
