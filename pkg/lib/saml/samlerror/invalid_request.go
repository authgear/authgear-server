...
var _ samlprotocol.SAMLErrorCodeError = &InvalidRequestError{}
...
func (s *InvalidRequestError) ErrorCode() samlprotocol.SAMLErrorCode {
	return samlprotocol.SAMLErrorCodeInvalidRequest
}
