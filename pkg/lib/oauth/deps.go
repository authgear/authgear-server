...
var DependencySet = wire.NewSet(
	...
	wire.Bind(new(AppInitiatedSSOToWebTokenAccessGrantService), new(*AccessGrantService)),
	wire.Bind(new(AppInitiatedSSOToWebTokenOfflineGrantService), new(*OfflineGrantService)),
)
