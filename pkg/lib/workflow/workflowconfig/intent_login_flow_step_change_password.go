...
func init() {
	workflow.RegisterPrivateIntent(&IntentLoginFlowStepChangePassword{})
}

var IntentLoginFlowStepChangePasswordSchema = validation.NewSimpleSchema(`{}`)
...
func (*IntentLoginFlowStepChangePassword) JSONSchema() *validation.SimpleSchema {
	return IntentLoginFlowStepChangePasswordSchema
}
...
func (*IntentLoginFlowStepChangePassword) GetEffects(ctx context.Context, deps *workflow.Dependencies, workflows workflow.Workflows) ([]workflow.Effect, error) {
	return nil, nil
}

func (*IntentLoginFlowStepChangePassword) OutputData(ctx context.Context, deps *workflow.Dependencies, workflows workflow.Workflows) (interface{}, error) {
	return nil, nil
}
