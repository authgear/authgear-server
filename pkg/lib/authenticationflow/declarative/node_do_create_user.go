...
var _ MilestoneSwitchToUser = &NodeDoCreateUser{}
...
func (n *NodeDoCreateUser) MilestoneSwitchToUser(newUserID string) {
	n.UserID = newUserID
	// MilestoneSwitchToUser is used in cases that the flow wants to update an existing user
