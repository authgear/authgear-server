...
func (q *Queries) ListClients(ctx context.Context, pageArgs graphqlutil.PageArgs, source *model.OAuthClientSource, clientIDs []string) (*oauthclient.ListClientResult, error) {
	return q.OAuthClientQueries.ListClients(ctx, pageArgs, source, clientIDs)
}
