...
// PersonsOrderByEnum the model 'PersonsOrderByEnum'
type PersonsOrderByEnum string

// List of PersonsOrderByEnum
const (
	NAME PersonsOrderByEnum = "name"
	DATE_OF_BIRTH PersonsOrderByEnum = "date_of_birth"
	GENDER PersonsOrderByEnum = "gender"
	NATIONALITY PersonsOrderByEnum = "nationality"
	MODIFIED_DATE PersonsOrderByEnum = "modified_date"
	CREATE_DATE PersonsOrderByEnum = "create_date"
)

// All allowed values of PersonsOrderByEnum enum
var AllowedPersonsOrderByEnumEnumValues = []PersonsOrderByEnum{
	"name",
	"date_of_birth",
	"gender",
	"nationality",
...
func (v *PersonsOrderByEnum) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PersonsOrderByEnum(value)
	for _, existing := range AllowedPersonsOrderByEnumEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PersonsOrderByEnum", value)
}

// NewPersonsOrderByEnumFromValue returns a pointer to a valid PersonsOrderByEnum
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPersonsOrderByEnumFromValue(v string) (*PersonsOrderByEnum, error) {
	ev := PersonsOrderByEnum(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PersonsOrderByEnum: valid values are %v", v, AllowedPersonsOrderByEnumEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PersonsOrderByEnum) IsValid() bool {
	for _, existing := range AllowedPersonsOrderByEnumEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PersonsOrderByEnum value
func (v PersonsOrderByEnum) Ptr() *PersonsOrderByEnum {
	return &v
}

type NullablePersonsOrderByEnum struct {
	value *PersonsOrderByEnum
	isSet bool
}

func (v NullablePersonsOrderByEnum) Get() *PersonsOrderByEnum {
	return v.value
}

func (v *NullablePersonsOrderByEnum) Set(val *PersonsOrderByEnum) {
	v.value = val
	v.isSet = true
}

func (v NullablePersonsOrderByEnum) IsSet() bool {
	return v.isSet
}

func (v *NullablePersonsOrderByEnum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePersonsOrderByEnum(val *PersonsOrderByEnum) *NullablePersonsOrderByEnum {
	return &NullablePersonsOrderByEnum{value: val, isSet: true}
}

func (v NullablePersonsOrderByEnum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePersonsOrderByEnum) UnmarshalJSON(src []byte) error {
	v.isSet = true
