...
// checks if the LivenessResultSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LivenessResultSchema{}

// LivenessResultSchema struct for LivenessResultSchema
type LivenessResultSchema struct {
	LivenessScore float32 `json:"liveness_score"`
}

type _LivenessResultSchema LivenessResultSchema

// NewLivenessResultSchema instantiates a new LivenessResultSchema object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLivenessResultSchema(livenessScore float32) *LivenessResultSchema {
	this := LivenessResultSchema{}
	this.LivenessScore = livenessScore
	return &this
}

// NewLivenessResultSchemaWithDefaults instantiates a new LivenessResultSchema object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewLivenessResultSchemaWithDefaults() *LivenessResultSchema {
	this := LivenessResultSchema{}
	return &this
}

// GetLivenessScore returns the LivenessScore field value
func (o *LivenessResultSchema) GetLivenessScore() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
func (o *LivenessResultSchema) GetLivenessScoreOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LivenessResultSchema) SetLivenessScore(v float32) {
	o.LivenessScore = v
}

func (o LivenessResultSchema) MarshalJSON() ([]byte, error) {
...
func (o LivenessResultSchema) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["liveness_score"] = o.LivenessScore
	return toSerialize, nil
}

func (o *LivenessResultSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varLivenessResultSchema := _LivenessResultSchema{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLivenessResultSchema)

	if err != nil {
		return err
	}

	*o = LivenessResultSchema(varLivenessResultSchema)

	return err
}

type NullableLivenessResultSchema struct {
	value *LivenessResultSchema
	isSet bool
}

func (v NullableLivenessResultSchema) Get() *LivenessResultSchema {
	return v.value
}

func (v *NullableLivenessResultSchema) Set(val *LivenessResultSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableLivenessResultSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableLivenessResultSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLivenessResultSchema(val *LivenessResultSchema) *NullableLivenessResultSchema {
	return &NullableLivenessResultSchema{value: val, isSet: true}
}

func (v NullableLivenessResultSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLivenessResultSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
