...
// OSEnum the model 'OSEnum'
type OSEnum string

// List of OSEnum
const (
	DESKTOP OSEnum = "DESKTOP"
	ANDROID OSEnum = "ANDROID"
	IOS OSEnum = "IOS"
)

// All allowed values of OSEnum enum
var AllowedOSEnumEnumValues = []OSEnum{
	"DESKTOP",
	"ANDROID",
	"IOS",
}

func (v *OSEnum) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := OSEnum(value)
	for _, existing := range AllowedOSEnumEnumValues {
	...
	return fmt.Errorf("%+v is not a valid OSEnum", value)
}

// NewOSEnumFromValue returns a pointer to a valid OSEnum
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewOSEnumFromValue(v string) (*OSEnum, error) {
	ev := OSEnum(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for OSEnum: valid values are %v", v, AllowedOSEnumEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v OSEnum) IsValid() bool {
	for _, existing := range AllowedOSEnumEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to OSEnum value
func (v OSEnum) Ptr() *OSEnum {
	return &v
}

type NullableOSEnum struct {
	value *OSEnum
	isSet bool
}

func (v NullableOSEnum) Get() *OSEnum {
	return v.value
}

func (v *NullableOSEnum) Set(val *OSEnum) {
	v.value = val
	v.isSet = true
}

func (v NullableOSEnum) IsSet() bool {
	return v.isSet
}

func (v *NullableOSEnum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOSEnum(val *OSEnum) *NullableOSEnum {
	return &NullableOSEnum{value: val, isSet: true}
}

func (v NullableOSEnum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOSEnum) UnmarshalJSON(src []byte) error {
	v.isSet = true
